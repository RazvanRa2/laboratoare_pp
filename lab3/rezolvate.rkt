...
;; Exercitiul 5 - suma elementelor unei liste utilizand apply
(define (sumlist L)
  (apply + L))

; (sumlist '(1 2 3 4 5))

;; Exercitiul 6 - suma elementelor unei liste utilizand foldr
(define (sumlist2 L)
  (foldr + 0 L))

; (sumlist2 '(1 2 3 4 5))

;; Exercitiul 7 - inversarea unei liste utilizand foldl
